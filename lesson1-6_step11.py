...
try: 
    ...
    input4 = browser.find_element_by_css_selector(".second_block>.form-group.first_class>.form-control.first")
    input4.send_keys("+7 7777777777")
    input5 = browser.find_element_by_css_selector(".second_block>.form-group.second_class>.form-control.second")
    input5.send_keys("Abaya 49")
